                ...
                <div style={popCard}>
                    ...
                    <div>
                        ...
                        <section style={flexCol}>
                            ...
                            <div ref={myRef} style={homePageCanvas}>
                            </div>
                            <span style={buttonContainer}>
                                <Button variant="contained" color="primary" style={saveWormButton} onClick={(e) => myP5.saveWorm(e)} id="saveWormButton">save worm</Button>
                                <Button variant="contained" color="primary" style={saveWormButton} onClick={(e) => myP5.exportWorm(e)} id="exportWormButton">export worm</Button>
                            </span>
